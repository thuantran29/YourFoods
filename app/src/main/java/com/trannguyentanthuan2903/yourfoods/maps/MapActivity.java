package com.trannguyentanthuan2903.yourfoods.maps;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private void getAddress() {
        ...
        idStore = myIntent.getStringExtra(Constain.ID_STORE_MAP);
        ...
        try {
            ...
            mData.child(Constain.STORES).child(idStore).child(Constain.LOCATION).child(Constain.ADDRESS).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    StringTokenizer tokens = new StringTokenizer(dataSnapshot.getValue().toString(), ",");
                    mSearchText.setText(tokens.nextToken());
                }
