...
public class FavoriteAdapter extends RecyclerView.Adapter<FavoriteViewHolder> {
    ...
    public FavoriteAdapter(ArrayList<Store> arrStore, FavoriteFragment favorite_fragment, String idUser, Context mContext) {
        this.arrStore = arrStore;
        this.favoriteFragment = favorite_fragment;
        this.idUser = idUser;
